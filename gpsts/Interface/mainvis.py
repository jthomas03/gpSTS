...
def gpvis(data_path = None, hyperparameter_path = None):
    """
    The main loop
    Parameters
    ----------
    ...
    error = {}
    measurement_costs = {}
    training_dask_client = conf.training_dask_client ##added
    ...
    conf.gaussian_processes[gp_idx]["plot function"](gp_optimizers[gp_idx],ind)

    print("########################################################")
    print("#######Visualization Concluded##########################")
    print("########################################################")

def randvis(data_path = None):
    """
    The main loop
    Parameters
    ----------
    ...
    #    )
    if ind > 2:
        for gp_idx in conf.random_process.keys():
            conf.random_process[gp_idx]["plot function"](d,ind)
